...
namespace AI_Midterm_RTS.UnityCore.Extensions
{
    /// <summary>
    ...
    public static class TransformExtensions
    {
        ...
        /// <summary>
        /// Sets the local scale X for this transform.
        /// </summary>
        /// <param name="transform">The transform to modify.</param>
        ...
        /// <summary>
        /// Sets the local scale Y for this transform.
        /// </summary>
        /// <param name="transform">The transform to modify.</param>
        ...
        /// <summary>
        /// Sets the local scale Z for this transform.
        /// </summary>
        /// <param name="transform">The transform to modify.</param>
